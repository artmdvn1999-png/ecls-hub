...
local texts = {
    VN = {
        ...
        -- Tab Update
        updateInfoText = "THÔNG TIN CẬP NHẬT (VERSION 5.0):\n\n1. Bổ sung thanh hiển thị FPS & MS (Ping) dạng hình chữ nhật nhỏ gọn.\n2. Tích hợp trọn vẹn các Tab: Player, Main, Speed, Ngôn Ngữ, Update.\n3. Nâng cấp độ ổn định của hệ thống Auto Steal và Server Hop.",
    },
    EN = {
        ...
        -- Tab Update
        updateInfoText = "UPDATE LOG (VERSION 5.0):\n\n1. Added compact rectangular FPS & MS (Ping) display bar.\n2. Integrated tabs: Player, Main, Speed, Language, Update.\n3. Upgraded stability for Auto Steal and Server Hop features.",
    }
}
...
-- ==================== THANH FPS & MS (HÌNH CHỮ NHẬT NHỎ GỌN) ====================
local FpsMsBar = Instance.new("Frame")
FpsMsBar.Name = "FpsMsBar"
FpsMsBar.Parent = ScreenGui
FpsMsBar.BackgroundColor3 = Color3.fromRGB(20, 20, 25)
FpsMsBar.BackgroundTransparency = 0.2
FpsMsBar.BorderSizePixel = 0
FpsMsBar.Position = UDim2.new(0.5, -90, 0, 10)
FpsMsBar.Size = UDim2.new(0, 180, 0, 28)
FpsMsBar.Active = true
FpsMsBar.Draggable = true

local BarCorner = Instance.new("UICorner")
BarCorner.CornerRadius = UDim.new(0, 6)
BarCorner.Parent = FpsMsBar

local BarStroke = Instance.new("UIStroke")
BarStroke.Color = Color3.fromRGB(70, 70, 85)
BarStroke.Thickness = 1.5
BarStroke.Parent = FpsMsBar

local FpsMsText = Instance.new("TextLabel")
FpsMsText.Parent = FpsMsBar
FpsMsText.BackgroundTransparency = 1
FpsMsText.Size = UDim2.new(1, 0, 1, 0)
FpsMsText.Font = Enum.Font.GothamBold
FpsMsText.TextColor3 = Color3.fromRGB(0, 255, 150)
FpsMsText.TextSize = 12
FpsMsText.Text = "FPS: 60 | MS: 0ms"

-- Cập nhật liên tục thông số FPS và Ping (MS)
local lastTick = tick()
local frameCount = 0
RunService.RenderStepped:Connect(function()
    ...
    if currentTick - lastTick >= 1 then
        ...
        FpsMsText.Text = "FPS: " .. fps .. " | MS: " .. ping .. "ms"
    end
end)
...
local function updateSpawnList()
    ...
    local count = 0
    for _, egg in pairs(eggsFolder:GetDescendan
